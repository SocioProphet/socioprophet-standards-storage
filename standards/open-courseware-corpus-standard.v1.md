...
The standard is designed for Michael-agent and related SocioProphet agents. It uses the institutions' own public materials where lawfully accessible and preserves provenance, licensing, source constraints, and assessment evidence.
...
```text
public course catalog -> degree requirement map -> public courseware -> assignments/labs -> published exams/tests -> agent assessment -> evidence bundle -> transfer evaluation
```
...
assessment_type: problem_set | quiz | midterm | final_exam | lab | project | paper | oral_defense_equivalent | code_review | other
...
attempt_mode: open_book | closed_book_simulated | timed_simulated | project_review | oral_defense_simulated | code_review
started_at: ISO-8601 datetime
completed_at: ISO-8601 datetime
outputs: EvidenceArtifact references
score: numeric, rubric, or pass/fail
reviewer: human, agent, or review role
review_state: draft | reviewed | accepted | rejected | remediation_required
...
- do not treat answer keys as proof of mastery without independent attempt, review, or holdout assessment.
...
4. Human or agent review: evidence is reviewed against rubric.
5. Transfer task: concept is applied to SocioProphet platform, MLOps, ontology, SourceOS, or Atlas work.
...
review_state: accepted | remediation_required | incomplete
```

## Relationship to evidence bundles

Every CoursewareCorpus, CourseMaterial, PublishedAssessment, and AssessmentAttempt must be backed by SourceRecord and EvidenceBundle objects under the Evidence Bundle Standard.
